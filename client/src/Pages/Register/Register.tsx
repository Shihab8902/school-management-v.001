...
const Register = () => {
    ...
    return <div className="min-h-screen   bg-white dark:bg-slate-900 lg:bg-gray-100 lg:dark:bg-[#18181B] flex justify-center items-center ">
        ...
        <div className=" md:w-8/12  w-full bg-transparent grid min-h-screen lg:grid-cols-2 p-5 md:p-10" >
            <div className="absolute border-2 p-2 border-gray-300 bg-gray-100 dark:border-gray-700 dark:bg-[#222831] rounded-md  z-10 md:hidden lg:block right-10 top-32" >
                <Toggler size={24} />
            </div>
            {/*Cover */}
                    ...
                    <form >
                        ...
                        <div className='mb-5'>
                            ...
                            <div className='flex items-center w-full bg-gray-200 dark:bg-gray-700   rounded-md '>
                                <select className='bg-transparent dark:bg-gray-700 cursor-pointer text-sm rounded-md text-black dark:text-white font-medium placeholder:font-normal py-3 px-2  w-full outline-none' defaultValue="" onChange={(e) => setAccountType(e.target.value)} name="accountType" id="accountType">
                        ...
                        {/* Id */}
                        {
                            accountType === "Teacher" && <div className='mb-5'>
                                ...
                                <div className='flex items-center w-full bg-gray-200 dark:bg-gray-700 px-3 rounded-md '>
                                    ...
                                    <input className='bg-transparent text-sm text-black dark:text-white font-medium placeholder:font-normal py-3 px-2  w-full outline-none' type="text" name="teacherId" id="teacherId" placeholder='Enter teacher id' />
                                </div>
                            </div>
                        ...
                        {/* Id */}
                        {
                            accountType === "Student" && <div className='mb-5'>
                                ...
                                <div className='flex items-center w-full bg-gray-200 dark:bg-gray-700 px-3 rounded-md '>
                                    <span ><MdOutlineNumbers className='text-xl text-gray-600 dark:text-white ' /></span>
                                    <input className='bg-transparent text-sm text-black dark:text-white font-medium placeholder:font-normal py-3 px-2  w-full outline-none' type="text" name="studentId" id="studentId" placeholder='Enter student id' />
                                </div>
                            </div>
